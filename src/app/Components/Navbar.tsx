...
const Navbar = () => {
    return (
        <nav className="bg-blue-900 h-24 w-full flex justify-around items-center ">
            ...
            <div className="absolute top-24 left-124 transform -translate-y-1/2 z-10">
            <Image src={img} alt="logo" height={20} width={120}></Image>
            </div>

            <div className="ml-96 text-3xl text-white pl-80">Tuition Free Education Program on Latest Technologies
            </div>

            <ul className="flex justify-between items-center p-10 text-white space-x-6 mr-96">
